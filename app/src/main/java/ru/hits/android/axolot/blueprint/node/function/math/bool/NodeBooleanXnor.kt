...
class NodeBooleanXnor : NodeFunction() {
    ...
    override operator fun invoke(context: InterpreterContext): Variable {
        val first = dependencies[NodeBooleanXnor.FIRST]!!.invoke(context)[Type.BOOLEAN]!!
        val second = dependencies[NodeBooleanXnor.SECOND]!!.invoke(context)[Type.BOOLEAN]!!
